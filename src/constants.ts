...
export const DEFAULT_CONTEXT_WINDOW_SIZE = 400000;
...
export const CHAT_THINKING_EFFORT_VALUES = ['none', 'low', 'medium', 'high', 'xhigh', 'max'] as const;
export type ChatThinkingEffort = (typeof CHAT_THINKING_EFFORT_VALUES)[number];
export const RESPONSES_THINKING_EFFORT_VALUES = ['low', 'medium', 'high', 'xhigh', 'max'] as const;
...
export const THINKING_TYPE_MODEL_OPTION_KEY = 'thinkingType';
export const PERSONALITY_MODEL_OPTION_KEY = 'personality';
